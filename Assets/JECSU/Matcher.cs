namespace JECSU
{
    ...
    public class Matcher
    {
        ...
        public void SetIs<T>() where T : BaseComponent
        {
        ...
        /// </summary>
        public void SetIs<T, T1>() where T : BaseComponent where T1 : BaseComponent
        {
            ...
            if (typeof(T1) != typeof(BaseComponent))
                throw new Exception("Matcher can only work with components");
        ...
        /// </summary>
        public void SetIs<T, T1, T2>() where T : BaseComponent where T1 : BaseComponent where T2 : BaseComponent
        {
            if (typeof(T) != typeof(BaseComponent))
                throw new Exception("Matcher can only work with components");
            observedPools.Add(Pool.GetIfnoneMakeNew<T>());
            ...
            if (typeof(T2) != typeof(BaseComponent))
                throw new Exception("Matcher can only work with components");
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static List<Entity> Is<T>() where T : BaseComponent
        {
        ...
        /// <returns></returns>
        public static List<Entity> Is<T>(List<Entity> entities) where T : BaseComponent
        {
            if (entities == null)
                return null;
        ...
        public static List<Entity> IsNot<T>() where T : BaseComponent
        {
        ...
        public static List<Entity> IsNot<T>(List<Entity> entities) where T : BaseComponent
        {
            if (entities == null)
                return null;
            int count = entities.Count;
